...
export const api = {
  ...
  getCursosDinamicos: async (rbd: string): Promise<CursoDinamico[]> => {
    ...
    return (data || []).map(c => ({
      ...
      modalidad_codocencia: c.modalidad_codocencia || c.modalidadCodocencia || 'Sin Co-docencia',
      estrategia_agrupacion: c.estrategia_agrupacion || c.estrategiaAgrupacion || 'Grupo Único',
      subgrupos_flexibles: c.subgrupos_flexibles || c.subgruposFlexibles || [],
  ...
  crearCursoDinamico: async (curso: CursoDinamico): Promise<void> => {
    ...
    const dbCurso: any = {
      ...
      modalidad_codocencia: curso.modalidad_codocencia || 'Sin Co-docencia',
      estrategia_agrupacion: curso.estrategia_agrupacion || 'Grupo Único',
      subgrupos_flexibles: curso.subgrupos_flexibles || [],
