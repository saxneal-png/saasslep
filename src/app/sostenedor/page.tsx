...
export default function SostenedorDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'compendio' | 'finanzas'>('dashboard');
        ...
        <main className="p-6 md:p-8 flex-1 flex flex-col gap-6 w-full animate-fadeIn">
          <div className="bg-white rounded-xl shadow border border-slate-200/60 p-6">
            ...
            {(() => {
              ...
              const totalHrsAula = asignaciones.reduce((sum, a) => sum + a.horas, 0);
              ...
              return (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                  <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-4 shadow-sm">
                    <p className="text-slate-500 text-[10px] uppercase font-bold">Total Liquidado</p>
                    <p className="text-lg font-extrabold text-slate-800 mt-1">${totalRemunerado.toLocaleString('es-CL')}</p>
                  </div>
                  <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-4 shadow-sm">
                    <p className="text-slate-500 text-[10px] uppercase font-bold">Horas Pagadas (Libro)</p>
