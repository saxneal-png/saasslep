...
export default function RRHHPage() {
  ...
  const filteredFuncionarios = funcionarios.filter(f => {
    ...
    const matchesRbd = filterRbd === 'all' || contratos.some(c => c.funcionario_run === f.run && normalizarRbd(String(c.rbd)) === normalizarRbd(String(filterRbd)));
                            ...
                            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 text-xs space-y-3">
                              ...
                              <div className="flex gap-2 items-center">
                                ...
                                >
                                  ...
                                  <option value="Artículo 69 Ley 19.070 (Reducción por 30+ años de servicio)">Artículo 69 Ley 19.070 (Reducción por 30+ años de servicio)</option>
                              ...
                              {/* Tooltip Legal Art 69 */}
                              {newCronoType.includes('Artículo 69') && (
                      ...
                      <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {activeLicencias.map(c => {
                            ...
                            const totalCubierto = reemps.reduce((acc, curr) => acc + curr.horas, 0);
                            const cubiertoCompletamente = totalCubierto >= c.horas_totales;
                            const task = tareas.find(t => t.funcionario_titular_run === c.funcionario_run && normalizarRbd(String(t.rbd)) === normalizarRbd(String(c.rbd)));
